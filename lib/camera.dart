...
class _CameraPageState extends State<CameraPage> {
  ...
  String predictedColorLabel = 'Detecting...';
  Color predictedColor = Colors.white;
  int kNeighbors = 5;
  ...
  void _processCameraImage(CameraImage image) {
    ...
    setState(() {
      ...
      predictedColor = Color.fromARGB(255, r, g, b);
      lastProcessedTime = DateTime.now();

      // Print predicted color
      print("Predicted Color: $predictedColorLabel");
    });
  }
                    ...
                    if (snapshot.connectionState == ConnectionState.done) {
                      return Stack(
                        children: [
                          ...
                          Positioned(
                              bottom: 20,
                              child: Text(predictedColorLabel,
                                  style: TextStyle(
